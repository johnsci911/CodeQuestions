<x-app-layout>
    <div class="filters flex flex-col md:flex-row md:space-x-6 space-y-4 md:space-y-0">
        ...
        <div class="w-full px-4 md:px-0 md:w-2/3 relative">
    ...
    <div class="ideas-container space-y-6 my-6 mx-4 md:mx-0">
        @foreach ($ideas as $idea)
            ...
            >
                ...
                <div class="flex flex-col md:flex-row flex-1 px-2 py-6 mx-3 md:mx-0">
                    <div class="flex-none">
                        <a href="#">
                            <img src="{{ $idea->user->getAvatar() }}" alt="avatar" class="w-14 h-14 rounded-xl">
                        </a>
                    </div>
                    <div class="mx-0 md:mx-4 w-full flex flex-col justify-between mt-2 md:mt-0">
                        <h4 class="text-xl font-semibold">
                            <a href="{{ route('idea.show', $idea) }}" class=" idea-link hover:underline">{{ $idea->title }}</a>
                        </h4>
                        <div class="text-gray-600 mt-3 line-clamp-3">{{ $idea->description }}</div>
                        <div class="flex flex-col md:flex-row md:items-center space-y-3 justify-between mt-6">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ul
                                        ...
                                        class="absolute z-10 w-44 text-left font-semibold bg-white shadow-dialog rounded-xl py-3 md:ml-8 top-8 md:top-6 -right-2 md:left-0"
                                    >
