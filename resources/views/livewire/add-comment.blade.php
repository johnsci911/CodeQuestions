    ...
    >
        @auth
            <form wire:submit.prevent="addComment" action="#" class="px-4 py-6 space-y-4">
                <textarea wire:model="comment" id="post_comment" name="post_comment" class="w-full px-4 py-2 text-sm placeholder-gray-900 bg-gray-100 border-none rounded-xl" placeholder="Go ahead, don't be shy. Share your thoughts..." cols="30" rows="4" required></textarea>
                @error('comment')
