            ...
            <div class="modal relative transform overflow-hidden rounded-tl-xl rounded-tr-xl bg-white transition-all sm:w-full sm:max-w-lg py-4">
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    ...
                    <form wire:submit.prevent="updateComment" action="#" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                            <textarea x-ref="editComment" wire:model.defer="body" id="body" name="body" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl placeholder-gray-900 text-sm px-4 py-2 border-none" placeholder="Edit Comment" required></textarea>
                            @error('body')
